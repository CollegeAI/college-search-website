...
export class Reviews extends React.Component<Props, State> {
  ...
  render() {
    ...
    const reviews = [
      ...
      {
        rating: 4,
        text: `Professors are very intelligent and are willing to put time into helping students.`,
        role: 'College Sophomore',
        date: 'June 22 2016',
        tags: [{ name: 'Overall Experience', id: 'overallExperience' }]
      },
      {
        rating: 4,
        text: `Campus and surrounding area feels pretty safe.`,
        role: 'College Sophomore',
        date: 'June 22 2016',
        tags: [{ name: 'Health & Safety', id: 'healthAndSafety' }]
      },
      {
        rating: 4,
        text: `Pretty random what type of housing you get, but overall it is pretty damn good.`,
        role: 'College Sophomore',
        date: 'June 22 2016',
        tags: [{ name: 'Housing', id: 'housing' }]
      }
    ]
