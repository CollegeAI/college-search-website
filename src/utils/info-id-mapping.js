...
const collegeInfoIds = [
  ...
  { infoId: "classSizeRangeOver100", path: "academics.rangeOver100" },
  { infoId: "classSizeRange2To9", path: "academics.range2To9" },
  { infoId: "classSizeRange10To19", path: "academics.range10To19" },
  { infoId: "classSizeRange20To29", path: "academics.range20To29" },
  { infoId: "classSizeRange30To39", path: "academics.range30To39" },
  { infoId: "classSizeRange40To49", path: "academics.range40To49" },
  { infoId: "classSizeRange50To99", path: "academics.range50To99" },
  {
  ...
  { infoId: "acceptanceRate", path: "admissions.acceptanceRate" },
  {
    ...
    path: "admissions.act.studentsSubmitting"
  },
  {
    infoId: "studentsSubmittingSAT",
    path: "admissions.sat.studentsSubmitting"
  },
  ...
  { infoId: "demographicsWhite", path: "demographics.white" },
  { infoId: "demographicsBlack", path: "demographics.black" },
  { infoId: "demographicsHisp", path: "demographics.hisp" },
  { infoId: "demographicsAsian", path: "demographics.asian" },
  { infoId: "demographicsAian", path: "demographics.aian" },
  { infoId: "demographicsNhpi", path: "demographics.nhpi" },
  { infoId: "demographics2mor", path: "demographics.2mor" },
  { infoId: "demographicsNra", path: "demographics.nra" },
  { infoId: "demographicsUnkn", path: "demographics.unkn" },
  ...
  { infoId: "typeYear", path: "schoolLevel" },
  ...
  { infoId: "campusImage", path: "imageResources.campus" },
  ...
  },
  {
    ...
    path: "rankings.theprincetonreviewbest382colleges2018"
  },
  {
    infoId: "collegesthatchangelivesfourthedition",
    path: "rankings.collegesthatchangelivesfourthedition"
  }
]
